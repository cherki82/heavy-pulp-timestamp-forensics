...
<body>
  ...
  <main id="content">
    ...
    <section id="robinson"><div class="wrap">
      <p class="kicker">Separate footage review · frame-exact event ledger</p><h2>Four visible clock discontinuities; 135 intermediate seconds not shown.</h2>
      <p class="section-intro">This review applies the same event convention used for Heavy Pulp: the listed boundary is the last old frame and first sustained new frame within one camera view. Displayed-clock change measures what is encoded in the CourtTV recording; it does not, by itself, establish that the same duration was deleted from an original surveillance file.</p>
      <div class="callout"><strong>4</strong><div><p>The four within-camera boundaries advance the displayed clock by <code>+00:02:19</code> in total. Subtracting the four ordinary one-second transitions leaves <code>135 seconds</code> of intermediate clock states not shown at those boundaries.</p><p>The first event occurs in the exterior stair/tunnel view. The other three occur in one continuous block from <code>CS - Roof - West - Overview Camera 4</code>.</p></div></div>
      <div class="event-list">
        <article class="event" id="robinson-001"><div class="event__copy"><p class="event__eyebrow">Robinson clock event</p><h3><a href="#robinson-001">#001</a></h3><dl class="facts"><div><dt>Video boundary</dt><dd>06:32.225 → 06:32.259</dd></div><div><dt>Source frames</dt><dd>11,755 → 11,756</dd></div><div><dt>View</dt><dd>Exterior stair / tunnel</dd></div><div><dt>Signed gap</dt><dd class="positive">+00:01:13</dd></div><div><dt>Intermediate seconds</dt><dd>72 not shown</dd></div><div><dt>Classification</dt><dd>Within-camera discontinuity</dd></div></dl><p class="clock"><span>Displayed clock</span>SEP 10 2025 11:53:17 AM → 11:54:30 AM</p><p>The person remains at the upper-left edge of the same labeled view. Playback reaches <code>11:54:33 AM</code> 0.63 CourtTV seconds later.</p></div><figure class="strip"><a href="evidence/robinson_stair_115317_to_115430.png"><img loading="lazy" width="1080" height="1180" src="evidence/robinson_stair_full_view.png" alt="Robinson exterior stair frames immediately before and after the 11:53:17 to 11:54:30 clock discontinuity"></a><figcaption>Full scene view. Open for exact source and enhanced timestamp pixels.</figcaption></figure></article>
        <article class="event" id="robinson-002"><div class="event__copy"><p class="event__eyebrow">Robinson clock event</p><h3><a href="#robinson-002">#002</a></h3><dl class="facts"><div><dt>Video boundary</dt><dd>09:06.146 → 09:06.179</dd></div><div><dt>Source frames</dt><dd>16,368 → 16,369</dd></div><div><dt>View</dt><dd>Overview Camera 4</dd></div><div><dt>Signed gap</dt><dd class="positive">+00:01:01</dd></div><div><dt>Intermediate seconds</dt><dd>60 not shown</dd></div><div><dt>Classification</dt><dd>Within-camera discontinuity</dd></div></dl><p class="clock"><span>Displayed clock</span>SEP 10 2025 12:15:59 PM → 12:17:00 PM</p><p>The moving white vehicle changes position across the adjacent frames. <code>12:15:58</code> is visible shortly before the exact boundary.</p></div><figure class="strip"><a href="evidence/robinson_day02_02_parking_121559_to_121700.png"><img loading="lazy" width="1080" height="1180" src="evidence/robinson_day02_02_parking_full_view.png" alt="Robinson parking Camera 4 frames immediately before and after the 12:15:59 to 12:17:00 clock discontinuity"></a><figcaption>Full scene view. Open for exact source and enhanced timestamp pixels.</figcaption></figure></article>
        <article class="event" id="robinson-003"><div class="event__copy"><p class="event__eyebrow">Robinson clock event</p><h3><a href="#robinson-003">#003</a></h3><dl class="facts"><div><dt>Video boundary</dt><dd>09:07.046 → 09:07.080</dd></div><div><dt>Source frames</dt><dd>16,395 → 16,396</dd></div><div><dt>View</dt><dd>Overview Camera 4</dd></div><div><dt>Signed gap</dt><dd class="positive">+00:00:03</dd></div><div><dt>Intermediate seconds</dt><dd>2 not shown</dd></div><div><dt>Classification</dt><dd>Within-camera discontinuity</dd></div></dl><p class="clock"><span>Displayed clock</span>SEP 10 2025 12:17:01 PM → 12:17:04 PM</p><p>The same vehicle advances abruptly in the same camera view.</p></div><figure class="strip"><a href="evidence/robinson_day02_03_parking_121701_to_121704.png"><img loading="lazy" width="1080" height="1180" src="evidence/robinson_day02_03_parking_full_view.png" alt="Robinson parking Camera 4 frames immediately before and after the 12:17:01 to 12:17:04 clock discontinuity"></a><figcaption>Full scene view. Open for exact source and enhanced timestamp pixels.</figcaption></figure></article>
        <article class="event" id="robinson-004"><div class="event__copy"><p class="event__eyebrow">Robinson clock event</p><h3><a href="#robinson-004">#004</a></h3><dl class="facts"><div><dt>Video boundary</dt><dd>09:07.247 → 09:07.280</dd></div><div><dt>Source frames</dt><dd>16,401 → 16,402</dd></div><div><dt>View</dt><dd>Overview Camera 4</dd></div><div><dt>Signed gap</dt><dd class="positive">+00:00:02</dd></div><div><dt>Intermediate seconds</dt><dd>1 not shown</dd></div><div><dt>Classification</dt><dd>Within-camera discontinuity</dd></div></dl><p class="clock"><span>Displayed clock</span>SEP 10 2025 12:17:04 PM → 12:17:06 PM</p><p>The vehicle advances again across adjacent frames in the same view.</p></div><figure class="strip"><a href="evidence/robinson_day02_04_parking_121704_to_121706.png"><img loading="lazy" width="1080" height="1180" src="evidence/robinson_day02_04_parking_full_view.png" alt="Robinson parking Camera 4 frames immediately before and after the 12:17:04 to 12:17:06 clock discontinuity"></a><figcaption>Full scene view. Open for exact source and enhanced timestamp pixels.</figcaption></figure></article>
      </div>
      <p class="kicker" style="margin-top:4rem">Other verified anomalies · kept separate from clock events</p><h2>Playback, camera, label, and repeat findings.</h2>
      <ul class="method-list">
        <li><b>Camera switches</b><code>12:10:07 → 12:15:20</code> occurs at Camera 1→4, and <code>12:17:17 → 12:22:11</code> at Camera 4→1. Because the view and camera label change, neither is counted as a within-camera timestamp jump.</li>
        <li><b>Playback hold</b>The courtroom-player image remains at <code>11:53:07</code> across widely separated broadcast samples, including a black/player interruption, before playback resumes. Other high-difference candidates retain the same clock value and are classified as monitor-refresh/compression changes, not clock events.</li>
        <li><b>Unmeasurable gaps</b>Day 1 has two black/player interruptions followed by returns to the same residential view. No clock pixels are recoverable after enhancement, so the intervening source time cannot be calculated.</li>
        <li><b>Conflicting labels</b>The same feature-matched diagonal stair view is labeled Level 2, then Level 1, then Level 2 again. This is a label inconsistency, not a mirrored reuse.</li>
        <li><b>Consecutive repeat</b>The official FBI file presents the same 177-frame / 17.7-second action block three times. Each presentation resets to the wide frame displaying <code>12:23:49 PM</code>.</li>
        <li><b>Mirror result</b>All 13 repeated-view and cross-source feature comparisons favored normal orientation. No horizontal flip candidate survived feature scoring or visual review.</li>
      </ul>
      <div class="evidence-grid">
        <figure><a href="evidence/robinson_same_stairs_conflicting_labels.jpg"><img loading="lazy" width="1600" height="601" src="evidence/robinson_same_stairs_conflicting_labels.jpg" alt="The same diagonal stair view displayed under Level 2, Level 1, and Level 2 labels"></a><figcaption>Same diagonal stair view under conflicting Level 2 / Level 1 labels.</figcaption></figure>
        <figure><a href="evidence/robinson_parking_camera_1_4_overlap.jpg"><img loading="lazy" width="1600" height="601" src="evidence/robinson_parking_camera_1_4_overlap.jpg" alt="Feature-matched overlap between parking Overview Cameras 1 and 4"></a><figcaption>Same physical parking area, but distinct Camera 1 and Camera 4 viewpoints.</figcaption></figure>
        <figure><a href="evidence/robinson_day01_no_timestamp_audit.png"><img loading="lazy" width="852" height="1728" src="evidence/robinson_day01_no_timestamp_audit.png" alt="Enhanced Day 1 corner and border review showing no recoverable embedded timestamp"></a><figcaption>Day 1 enhancement audit: no recoverable embedded timestamp.</figcaption></figure>
      </div>
      <p class="kicker" style="margin-top:4rem">The only cross-dataset comparison</p><h2>Stair event #001 and Heavy Pulp events #002–003.</h2>
      <div class="callout"><strong>69s</strong><div><p>Robinson event #001 is <code>11:53:17 → 11:54:30</code>. Heavy Pulp event #002 in Provo time is <code>11:53:01 → 11:54:27</code>, so the two events omit the same displayed seconds from <code>11:53:18</code> through <code>11:54:26</code>: 69 shared absent clock labels.</p><p>Heavy Pulp event #003 starts exactly at Robinson's <code>11:54:30</code> destination and ends at <code>11:54:36</code>. Robinson reaches <code>11:54:33</code> 0.63 seconds after its boundary, inside that range. The event starts are not identical, and the calendar years differ by 24 years.</p></div></div>
      <div class="evidence-grid">
        <figure><a href="evidence/sustained_002_frames_0253_0254.png"><img loading="lazy" width="1448" height="327" src="evidence/sustained_002_frames_0253_0254.png" alt="Heavy Pulp source frames at sustained timestamp event 2"></a><figcaption>Heavy Pulp #002. Source pixels show Sedona time; Provo time is one hour later.</figcaption></figure>
        <figure><a href="evidence/robinson_stair_115317_to_115430.png"><img loading="lazy" width="1080" height="1180" src="evidence/robinson_stair_full_view.png" alt="Robinson exterior stair sequence at the 11:53:17 to 11:54:30 boundary"></a><figcaption>Robinson #001: exact adjacent-frame destination <code>11:54:30</code>.</figcaption></figure>
        <figure><a href="evidence/sustained_003_frames_0370_0371.png"><img loading="lazy" width="1448" height="327" src="evidence/sustained_003_frames_0370_0371.png" alt="Heavy Pulp source frames at sustained timestamp event 3"></a><figcaption>Heavy Pulp #003 begins at the same <code>11:54:30</code> Provo clock value.</figcaption></figure>
      </div>
      <p class="interpretive-limit"><b>Comparison limit.</b> No Heavy Pulp comparison is drawn from the other Robinson clock events, camera changes, phone/message times, reporting times, labels, repeats, or interruptions. The numerical comparison is restricted to the stair sequence above.</p>
      <div class="downloads"><a class="button button--primary" href="reports/robinson_temporal_comparison.md">Full Robinson event review</a><a class="button" href="https://www.youtube.com/watch?v=y6ofpz6ReuE&amp;t=3083s">CourtTV Day 2 at stair event #001</a><a class="button" href="https://www.fbi.gov/video-repository/utah-valley-shooting-video-091025.mp4/view">Official FBI video source</a></div>
      <p class="source-note">The CourtTV files are recordings of a courtroom monitor, not clean exports of the underlying exhibits. Frame numbers are zero-based decoded frames; displayed clock values were read visually from source crops, with enhancement used only to test low-contrast areas. The case remains at the preliminary-hearing stage.</p>
    </div></section>
